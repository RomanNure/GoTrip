...
{
    public class CustomGuidePropositionNotification : NotificationBase
    {
        private const string SERVER_METHOD_CONFIRM = "custom/guide/invitation/accept/admin";
        private const string SERVER_METHOD_REFUSE = "custom/guide/invitation/refuse/admin";
        ...
        public CustomGuidePropositionNotification(string id, bool isChecked, string topic, Tour tour, Guide guide, double sum) : 
